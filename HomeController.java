...
public class HomeController {
	...
	/**
	* Opens the inventory screen, where everything the player owns is listed.
	*/
	...
	/**
	* Opens the market screen, where the player can buy and sell ingredients.
	*/
	...
	*/
	...
	/**
	* Opens the spellbook screen, which lists the recipes the player has unlocked.
	*/
	...
	/**
	* Claims the free ingredient that the login bonus gives out once per session.
	*/
