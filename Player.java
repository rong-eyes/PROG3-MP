...
public class Player {
	...
	* @param market the market, so that the attempt is counted towards the market refresh even if it fails
	...
	*/
	public int brewCreative(Cauldron cauldron, ArrayList<Recipe> recipes, Market market) {
		...
		market.recordBrew(); //the attempt counts towards the market refresh whether or not it works out
