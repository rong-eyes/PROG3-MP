...
public class Player {
	...
	public void BrewConcoction(boolean isCreative, Cauldron cauldron, Scanner s) { //this is what will be called in the menu option
		...
		//RECIPE MODE 
			...
			while(opt > spellbook.getUnlockedRecipes().size() && opt < 0) {
				opt = s.nextInt();
